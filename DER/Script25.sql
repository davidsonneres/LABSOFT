...
CREATE TABLE Corretora (
	...
	Email CHAR(50),
	IdCompra INT NOT NULL,
	PRIMARY KEY (IdCompra,CNPJCorretora)
);
...
ALTER TABLE Compra ADD CONSTRAINT CompraTemCorretora FOREIGN KEY (IdCompra, CNPJCorretora)
	REFERENCES Corretora (IdCompra, CNPJCorretora)
	ON DELETE CASCADE;
